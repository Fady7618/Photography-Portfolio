...
function Pricing() {
  return (
    <div className='w-full h-full lg:h-screen flex flex-col lg:flex-row justify-between items-center gap-3 px-4 my-2'>
      {/* Left Section */}
      ...
      {/* Right Section */}
      <div className="w-full lg:w-1/3 h-auto py-1 flex flex-col items-center gap-2">
